...
//Q 1. What are the different types of HTTP requests?
// HTTP (Hypertext Transfer Protocol) specifies a collection of request methods to specify what action is to be performed on a particular resource. The most commonly
// used HTTP request methods are GET, POST, PUT, PATCH, and DELETE. These are equivalent to the CRUD operations (create, read, update, and delete).
...
//Q 2. Explain the concept of middleware in Node.js.
...
//Q 4. What is Express? How does it help you to create a backend application?
...
// 1.More features than Node.js
// 2.It is used to build web-apps using approaches and principles of Node.js.
// 3.Routing is provided.
// 4.It requires less coding time.
// 5.Uses middleware for the arrangement of functions systematically server-side.
// 6.import by const express = require ("express")

//Q 5. Explain min 5 status codes gets used in Backend development.
...
//Q 6. Difference between HTTP and HTTPS.?
...
// As a result, HTTPS is far more secure than HTTP. A website that uses HTTP has 
// http:// in its URL, while a website that uses HTTPS has 
// https://. Some difference of http and https;


// Q 6. What are JWT tokens?
//JSON web token (JWT), pronounced "jot", is an open standard (RFC 7519) that defines a compact and self-contained way for securely transmitting 
//information between parties as a JSON object. Again, JWT is a standard, meaning that all JWTs are tokens, but not all tokens are JWTs. when we logged-in somewhere , 
